...
{$ENDIF FPC}
  ...
  ZDB2_FileEncoder, ZDB2_Core, zExpression;
...
begin
  ...
  TCompute.RunP_NP(procedure
    ...
    begin
      ...
      try
        for i := 0 to FDecoder.Files.Count - 1 do
          begin
            FDecoder.DecodeToDirectory(FDecoder.Files[i], DirectoryEdit.Text);
            if FDecoder.Aborted then
                break;
          end;
